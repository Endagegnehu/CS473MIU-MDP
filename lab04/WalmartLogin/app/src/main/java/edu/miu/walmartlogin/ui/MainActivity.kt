...
class MainActivity : AppCompatActivity() {
    ...
    val users = mutableListOf(
        User("test", "test", "test@miu.com", "testpass"),
        User("test1", "test1", "test1@miu.com", "testpass"),
        User("test2", "test2", "test2@miu.com", "testpass"),
        User("test3", "test3", "test3@miu.com", "testpass"),
        User("test4", "test4", "root@miu.com", "testpass")
    )
