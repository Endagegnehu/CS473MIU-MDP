...
class SplashFragment : BaseFragment() {
    ...
    fun addQuestionsToDB(){
        val quiz1 = Quiz(1L,"1) Which of the following is the first callback method that is invoked by the system during an activity life-cycle?",
            "A. onClick() method",
            "B. onCreate() method",
            "C. onStart() method",
            "D. onRestart() method",
            "b",
            "onCreate() method is called when activity is first created. The onCreate() and onDestroy() methods are called only once throughout the activity lifecycle.")
        val quiz2 = Quiz(2L,"2) Which of the following is not an activity lifecycle callback method?",
            "A. onClick() method",
            "B. onCreate() method",
            "C. onStart() method",
            "D. onBackPressed() method",
            "d","Answer: (d) onBackPressed() method\n")
